<template>
  <div>
    ...
    <main class="section-wrap">
      ...
      <!-- ROW 1: Get In Touch + Contact Form -->
            ...
            <form @submit.prevent="submitContact">
              ...
              <div class="row g-3">
                ...
                <div class="col-12">
                  ...
                  <textarea v-model="contact.message" rows="4" class="form-control" required></textarea>
                </div>

                <div class="col-12">
                  <button type="submit" class="btn btn-primary submit-btn">Submit Message</button>
                </div>
          ...
          <div class="glass-card h-100">
            ...
            <form @submit.prevent="submitIssue">
              ...
              <div class="row g-3">
                ...
                <div class="col-12">
                  <label class="form-label">Full name</label>
                  <input v-model="issue.iname" type="text" class="form-control" required>
                </div>

                <div class="col-md-6">
                  <label class="form-label">Email</label>
                  <input v-model="issue.iemail" type="email" class="form-control" required>
                </div>

                <div class="col-md-6">
                  <label class="form-label">Phone</label>
                  <input v-model="issue.iphone" type="tel" class="form-control" required>
                </div>

                <div class="col-12">
                  <label class="form-label">Booking ID (optional)</label>
                  <input v-model="issue.bookingId" type="text" class="form-control">
                </div>

                <div class="col-12">
                  <label class="form-label">Describe the issue</label>
                  <textarea v-model="issue.idescription" rows="5" class="form-control" required></textarea>
                </div>

                <div class="col-12">
                  <button type="submit" class="btn btn-outline-primary submit-issue-btn">
                    Submit Issue
                  </button>
                </div>
      ...
      <div class="map-wrap mt-4">
        <div class="container">
          <div class="glass-card p-3">
            <iframe
              src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d7824.353051369362!2d75.9895673905588!3d11.321804705448022"
              loading="lazy">
            </iframe>
          </div>
        </div>
  ...
  <style scoped>
        ...
        .page-hero {
            height: 48vh;
            background: url('./static/img/home/contact.jpg') center/cover no-repeat;
            position: relative;
            display: flex;
            align-items: center;
        ...
        .report-box {
            ...
            height: 100%;
            min-height: 180px;
            background: url('./static/img/home/issue.jpg') center/cover no-repeat;
